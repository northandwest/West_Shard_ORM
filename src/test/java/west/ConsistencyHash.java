...
public class ConsistencyHash {   
     ...
     */  
     ...
     public static void main(String[] args) {   
         ...
         for(int i=0; i<50; i++) {   
            byte[] computeMd5 = hash.computeMd5(String.valueOf(i));
			int vIRTUAL_NUM2 = hash.VIRTUAL_NUM;
			int nextInt = ran.nextInt(vIRTUAL_NUM2);
			System.out.println(hash.getShardInfo(hash.hash(computeMd5,nextInt)));   
         }   
   }   
